...
(
  ...
  CONSTRAINT FK_CUSTOMER_ORDER FOREIGN KEY (CUSTOMER_DNI) REFERENCES USERS(DNI)
)ENGINE = INNODB, CHARSET = UTF8;
...
(
  ...
  USER_COD CHAR(8) NOT NULL,
  CONSTRAINT FK_ROL FOREIGN KEY (ROL_ID) REFERENCES ROLES(ROL_ID),
  CONSTRAINT FK_USER FOREIGN KEY (USER_COD) REFERENCES USERS(COD),
